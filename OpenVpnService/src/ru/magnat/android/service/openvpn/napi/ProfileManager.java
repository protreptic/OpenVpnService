...
public class ProfileManager {
	...
	private static VpnProfile sLastConnectedVpn;
	...
	private static VpnProfile get(String key) {
		...
		return sInstance.profiles.get(key);
	}
	...
	public static void setConnectedVpnProfile(Context c,
			VpnProfile connectedrofile) {
		SharedPreferences prefs = PreferenceManager
				.getDefaultSharedPreferences(c);
		Editor prefsedit = prefs.edit();
		...
		prefsedit.apply();
		sLastConnectedVpn = connectedrofile;
	...
	public void saveProfile(Context context, VpnProfile profile) {
		...
		try {
			vpnfile = new ObjectOutputStream(context.openFileOutput((profile
					.getUUID().toString() + ".vp"), Activity.MODE_PRIVATE));
	...
	private void loadVPNList(Context context) {
		...
		SharedPreferences listpref = context.getSharedPreferences(PREFS_NAME,
		...
		for (String vpnentry : vlist) {
			try {
				ObjectInputStream vpnfile = new ObjectInputStream(
						context.openFileInput(vpnentry + ".vp"));
	...
	public void removeProfile(Context context, VpnProfile profile) {
		...
		if (sLastConnectedVpn == profile)
			sLastConnectedVpn = null;
